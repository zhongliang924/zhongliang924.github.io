---
layout: post
title: GitHub + Spinx + Read the docs实战入门指南（二）
categories: sphinx
---

本文介绍使用 Sphinx 生成个人文档第二部分
...
![image-20230508205853729](/images/posts/image-20230508205853729.png)
...
- 第一节在执行`sphinx-quickstart`后，我们的代码目录位于`D:\ProgramFile\TestProject`，接下来我们要将其部署到Github中。首先在Github上创建一个diary仓库
  ...
  ![image-20230508210621585](/images/posts/image-20230508210621585.png)
...
- 去Github界面查看，示例图如下：
  ...
  ![](/images/posts/image-20230508210952148.png)
...
- 成功后，点击右上角阅读文档即可查看
  ...
  ![image-20230508212613423](/images/posts/image-20230508212613423.png)

...
![image-20230712170149996](/images/posts/image-20230712170149996.png)
...
![image-20230710144141465](/images/posts/image-20230710144141465.png)
...
![image-20230712105203118](/images/posts/image-20230712105203118.png)

在设置系统环境变量界面，新建一个 JAVA_HOME 的环境变量，变量值就是上面的地址：

![image-20230712105048622](/images/posts/image-20230712105048622.png)

然后在系统环境变量 Path 中添加路径，路径名为前面的路径 + \bin：

![image-20230712105119183](/images/posts/image-20230712105119183.png)

新建一个 CMD，验证环境变量添加成功：

![image-20230711172318909](/images/posts/image-20230711172318909.png)
...
3. 编译服务器
   ...
   ![image-20230711204601798](/images/posts/image-20230711204601798.png)

   在环境变量配置目录添加用户环境变量：

   ![image-20230711204741483](/images/posts/image-20230711204741483.png)
...
4. 编译完成后运行服务器：
   ...
   ![image-20230711205048644](/images/posts/image-20230711205048644.png)
...
5. 从另一个终端来构建客户端并将其安装在设备上：
   ...
   ![image-20230711212005838](/images/posts/image-20230711212005838.png)

   能够在手机上安装 APP

6. 输入文本和相应的地址，能够得响应

   ![image-20230712111217609](/images/posts/image-20230712111217609.png)
...
![image-20230712165235512](/images/posts/image-20230712165235512.png)
...
![image-20230713152648112](/images/posts/image-20230713152648112.png)

客户端按上述的编译环境编译后下载 APP 到手机上：输入 URL 地址为：10.0.0.241:8980，点击 START ROUTE GUIDE，有四个功能分别对应四种调用服务方法：

![image-20230713153018776](/images/posts/image-20230713153018776.png)

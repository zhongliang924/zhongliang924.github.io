...
![image-20230607171857479](/images/wiki/image-20230607171857479.png)
...
![image-20230607172655204](/images/wiki/image-20230607172655204.png)

可以看到容器已经映射到 8000 号端口上了，在浏览器输入 [localhost:8000](http://localhost:8000) 即可打开共享文件管理目录，默认的用户名和密码均为 "admin"。

![image-20230607172919446](/images/wiki/image-20230607172919446.png)	
